...
∙ In addition, when ordering, I require visual references from the client. It can be simple symbolic drawings and/or a collage of images. Additional fees will be charged if I have to collect them myself.
...
∙ The commission of one product may take up to 2 months, depending on complexity and my availability. I will inform the client if I require more time.
...
∙ Most custom commissions are presumed for personal usage unless stated otherwise by the client when ordering.
∙ Stream assets and promotional graphics will be considered as semi-commercial, meaning that the client may profit off of it indirectly.
